...
def audio_tagging(args):
    ...
    if len(args.ensemble) > 0:
        ...
        model = get_mobilenet(width_mult=NAME_TO_WIDTH(model_name), pretrained_name=model_name,num_classes=3)
    model.to(device)
    model.eval()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='mn30_urban')
    parser.add_argument('--cuda', action='store_true', default=False)
    parser.add_argument('--audio_path', type=str, default="resources/si (2).wav")
